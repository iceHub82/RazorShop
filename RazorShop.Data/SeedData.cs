...
internal static class SeedData
{
    ...
    private static void SeedCategories(ModelBuilder builder)
    {
        builder.Entity<Category>().HasData(
            new Category { Id = 1, Name = "Drawings", StatusId = (int)EntityStatus.Active },
            new Category { Id = 2, Name = "Clothing", StatusId = (int)EntityStatus.Active }
        );
    }
    ...
    private static void SeedProducts(ModelBuilder builder)
    {
        builder.Entity<Product>().HasData(
            new Product { Id = 1, Name = "Drawing 1", ShortDescription = "Short Drawing 1", Description = "Generative plot drawing 1", Price = 499.00m, CategoryId = 1, StatusId = (int)EntityStatus.Active },
            new Product { Id = 2, Name = "Drawing 2", ShortDescription = "Short Drawing 2", Description = "Generative plot drawing 2", Price = 249.00m, CategoryId = 1, StatusId = (int)EntityStatus.Active },
            new Product { Id = 3, Name = "Drawing 3", ShortDescription = "Short Drawing 3", Description = "Generative plot drawing 3", Price = 349.00m, CategoryId = 1, StatusId = (int)EntityStatus.Active },
            new Product { Id = 4, Name = "T-Shirt 1", ShortDescription = "Short T-Shirt 1", Description = "T-Shirt with motive 1", Price = 149.00m, CategoryId = 2, StatusId = (int)EntityStatus.Active },
            new Product { Id = 5, Name = "T-Shirt 2", ShortDescription = "Short T-Shirt 2", Description = "T-Shirt with motive 2", Price = 299.00m, CategoryId = 2, StatusId = (int)EntityStatus.Active },
            new Product { Id = 6, Name = "T-Shirt 3", ShortDescription = "Short T-Shirt 3", Description = "T-Shirt with motive 3", Price = 99.00m, CategoryId = 2, StatusId = (int)EntityStatus.Active }
        );
    }
